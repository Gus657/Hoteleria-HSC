...
namespace Hoteleria
{
    public partial class HSC_CheckOut : Form
    {
        ...
        string[] listaBotones;
        int[] listaCodH;
        public HSC_CheckOut(string usuario)
        {
            InitializeComponent();
            sIdUsuario = usuario;
            cantidad();
        ...
        void MiBoton_Click(object sender1, EventArgs e1, int codHab)
        {
            ...
            ProcesarCheckOut nuevo = new ProcesarCheckOut(codigo, sIdUsuario);
            this.Close();
            nuevo.Show();
        }
        ...
        private void HSC_CheckOut_Load(object sender, EventArgs e)
        {
